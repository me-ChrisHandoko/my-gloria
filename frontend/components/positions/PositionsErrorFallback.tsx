/**
 * Positions Error Fallback Component
 *
 * Client-side error handling component for position page failures.
...
export default function PositionsErrorFallback({
  error
}: PositionsErrorFallbackProps) {
  return (
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-muted-foreground">
          Kelola data posisi dalam organisasi YPK Gloria
        </p>
      </div>
