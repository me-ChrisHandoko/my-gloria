...
export default function PermissionsDataTable({ permissions, sortBy, sortOrder, onSortChange }: PermissionsDataTableProps) {
            ...
            <Table>
                <TableHeader>
                    <TableRow>
                        {/* Sortable: Code */}
                        <TableHead>
                            <Button variant="ghost" onClick={() => onSortChange("code")} className="h-8 flex items-center">
                                Kode
                                {getSortIcon("code")}
                            </Button>
                        </TableHead>
                        ...
                        {/* Sortable: Name */}
                        <TableHead>
                            <Button variant="ghost" onClick={() => onSortChange("name")} className="h-8 flex items-center">
                                Nama Permission
                                {getSortIcon("name")}
                            </Button>
                        </TableHead>
                        ...
                        {/* Sortable: Status */}
                        <TableHead>
                            <Button variant="ghost" onClick={() => onSortChange("is_active")} className="h-8 flex items-center">
                                Status
