...
const TableCell = React.forwardRef<HTMLTableCellElement, React.TdHTMLAttributes<HTMLTableCellElement>>(({ className, ...props }, ref) => <td ref={ref} className={cn("py-1 px-4 align-middle [&:has([role=checkbox])]:pr-0", className)} {...props} />);
