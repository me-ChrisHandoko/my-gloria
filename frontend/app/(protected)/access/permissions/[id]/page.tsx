          ...
          <div className="space-y-1">
            ...
            <div>
              {permission.scope ? (
                ...
                <span className="text-sm text-muted-foreground">Tidak ada scope</span>
              )}
            </div>
          </div>
          ...
          <div className="space-y-1">
            ...
            <div>
              {permission.category ? (
                ...
                <span className="text-sm text-muted-foreground">Tidak ada category</span>
              )}
            </div>
          </div>
        </CardContent>
      ...
      <Card>
        ...
        <CardContent className="grid gap-4 md:grid-cols-2">
          ...
          <div className="space-y-1">
            ...
            <p className="text-sm">
              {permission.created_at ? format(new Date(permission.created_at), "dd MMM yyyy, HH:mm") : "-"}
            </p>
          </div>
          ...
          <div className="space-y-1">
            ...
            <p className="text-sm">
              {permission.updated_at ? format(new Date(permission.updated_at), "dd MMM yyyy, HH:mm") : "-"}
            </p>
          </div>
        </CardContent>
      </Card>
