...
type AuditLog struct {
	...
	// Relations
	ActorProfile      *UserProfile `json:"actor_profile,omitempty" gorm:"foreignKey:ActorProfileID"`
	TargetUserProfile *UserProfile `json:"target_user_profile,omitempty" gorm:"foreignKey:TargetUserID"`
}

// TableName specifies the table name for AuditLog
func (AuditLog) TableName() string {
	return "gloria_ops.audit_logs"
}
...
func (a *AuditLog) ToResponse() *AuditLogResponse {
	...
	if a.ActorProfile != nil && a.ActorProfile.DataKaryawan != nil {
		resp.ActorName = a.ActorProfile.DataKaryawan.Nama
	}

	if a.TargetUserProfile != nil && a.TargetUserProfile.DataKaryawan != nil {
		resp.TargetUserName = a.TargetUserProfile.DataKaryawan.Nama
	}
