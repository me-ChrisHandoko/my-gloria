...
// DataKaryawan represents employee master data from gloria_master schema
...
type DataKaryawan struct {
	...
	// Relations - cross-schema relation to UserProfile in gloria_ops
	UserProfile *UserProfile `json:"user_profile,omitempty" gorm:"foreignKey:NIP;references:NIP"`
}

// TableName specifies the table name for DataKaryawan in gloria_master schema
func (DataKaryawan) TableName() string {
	return "gloria_master.data_karyawan"
}
